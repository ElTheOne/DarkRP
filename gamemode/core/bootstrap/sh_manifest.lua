...
local Manifest = {
	Shared = {
		...
		"core/jobs/shared/sh_jobs.lua", "core/economy/shared/sh_supporter.lua", "core/admin/shared/sh_admin.lua",
	...
	ClientShared = { "core/government/shared/sh_mayor_tablet.lua", "core/world/shared/sh_worldentities.lua" },
	ServerPreload = { "core/government/shared/sh_mayor_tablet.lua" },
	Server = {
		...
		"core/inventory/server/sv_salvage.lua", "core/inventory/server/sv_crafting.lua", "core/jobs/server/sv_jobentities.lua",
		...
		"core/government/server/sv_legal.lua", "core/government/server/sv_police_records.lua", "core/incidents/server/sv_hits.lua",
		"core/props/server/sv_props.lua", "core/admin/server/sv_admin.lua", "core/incidents/server/sv_massie.lua",
		...
		"core/economy/server/sv_economy.lua", "core/economy/server/sv_economy_director.lua", "core/economy/server/sv_contracts.lua",
	...
	Client = {
		"core/ui/client/cl_ui.lua", "core/foundation/client/cl_content_delivery.lua", "core/calendar/client/cl_calendar.lua",
		"core/ui/client/cl_context.lua", "core/progression/client/cl_objectives.lua", "core/incidents/client/cl_medical.lua",
		"core/foundation/client/cl_roster.lua", "core/ui/client/cl_visuals.lua", "core/government/client/cl_government.lua",
		"core/government/client/cl_mayor_tablet.lua", "core/jobs/client/cl_jobentities.lua", "core/government/client/cl_armory.lua",
		"core/economy/client/cl_contracts.lua", "core/media/client/cl_arcade.lua", "core/media/client/cl_mp3player.lua",
	...
	ClientSubmodules = {
		"core/admin/client/cl_main.lua", "core/admin/client/cl_announcements.lua",
	...
	ClientResources = {
		...
		"core/toolgun/stools/drp_property_zone.lua", "core/toolgun/stools/precision.lua",
