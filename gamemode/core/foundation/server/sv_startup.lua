...
local required = {
	...
	{ name = "identity", methods = { "Load", "Save", "Open", "Register", "IsRegistered", "BuildSnapshot", "ApplyAppearance", "UpdateName" } },
	{ name = "network", methods = { "Receive", "Allow", "SendProfile", "Record" } },
	{ name = "props", methods = { "TrustEntityLimit", "OwnedEntityCount", "CanCreateOwnedEntity", "TrackOwnedEntity", "SpawnPurchased", "QueueCleanup", "CancelCleanup" } },
	...
	{ name = "salvage", methods = { "RegisterEntity", "Open", "BuildSnapshot", "TransferToHands", "ReturnToBin", "RefreshIfDue", "PopulationCount", "SchematicPopulationFactor", "SchematicChance", "RollSchematicGrade", "Save", "Status" } },
	{ name = "crafting", methods = { "BuildCatalog", "RefreshARC9Catalog", "Recipe", "CanCraft", "StartCraft", "CancelCraft", "CompleteCraft", "ClaimOutput", "LearnSchematic", "Dismantle", "GenerateSchematicLoot", "Mastery", "AddMastery", "RegisterTable", "BuildSnapshot", "SavePlayer", "SaveWorld", "Status", "ValidateCoverage" } },
	{ name = "hints", methods = { "Send", "CivicGuidance", "ScheduleMugging", "Start", "Stop" } },
	{ name = "mugging", methods = { "Begin", "PayDemand", "Scan", "Start", "Stop" } },
	{ name = "objectives", methods = { "RefreshOffers", "RefreshAll", "PruneInvalid", "Accept", "Dismiss", "CancelActive", "Emit", "Complete", "Sync", "BuildRoleGoal", "SetRoleGoal", "CheckRoleGoal", "EnsureBeginnerGuide", "SaveGuideProgress", "Popup" } },
	{ name = "social_objectives", methods = { "CanOffer", "SelectTarget", "Begin", "Cancel", "Complete", "HitFinished", "Start", "Stop" } },
	{ name = "mercenaries", methods = { "CanOffer", "Begin", "Cancel", "Complete", "DirectNPC", "DirectorTick", "ArmDirector", "Status", "Start", "Stop" } },
	{ name = "contracts", methods = { "BuildSnapshot", "Sync", "SyncAll", "SyncAllNow", "AddAimedEntity", "AddPocketItem", "BeginNegotiation", "TryAccept", "Fulfill", "Timeout", "HandleDisconnect" } },
	...
	{ name = "experience", methods = { "Add", "SetTotalXP", "SetPersistentField", "XPNeededForNext", "BuildSnapshot", "SendSnapshot", "NormalizePersistentState", "NormalizeUnlockedItems", "IsPrestigeWeapon", "GrantLoadoutWeapons", "CanPrestige", "Prestige", "IsMaxPrestige" } },
	...
	{ name = "roles", methods = { "InitializePlayer", "Normalize", "EnsureBehavior", "Resolve", "DerivedJob", "InitialJob", "Record", "RecordHitEvidence", "Evaluate", "BuildSnapshot", "Serialize", "CanAccessRoleTools" } },
	...
	{ name = "evidence_scanner", methods = { "Capture", "BuildWarrants", "SendWarrants", "IllegalKind" } },
	{ name = "police_npcs", methods = { "Load", "Save", "BeginRecording", "RecordAction", "FinishRecording", "CancelRecording", "DeleteRoute", "SetRouteNPCCount", "RenameRoute", "PreviewRoute", "NearestRoute", "AssignNearestRoute", "DesiredCount", "Reconcile", "PatrolTick", "ArrestOnSpot", "Start", "Stop" } },
	...
	{ name = "economy", methods = { "SavePlayer", "QueueSave", "FlushQueuedOutbox", "WriteOutbox", "RecoverPlayerRow", "Reward", "SettleTransfer", "Transfer" } },
	{ name = "economy_director", methods = { "BeginTransaction", "Commit", "RecordMoney", "RecordBurn", "RecordItem", "Quote", "LootFactor", "FairValue", "MoneySummary", "EconomicPressure", "TransactionBurnRate", "CalculateTransactionBurn", "Snapshot", "Warnings", "QueueJournal", "FlushJournal", "Reconcile", "SetPolicy", "RegisterVendor", "RegisterLootSource", "Save", "Status" } },
	{ name = "bonds", methods = { "PayoutFor", "BurnLimitFactor", "OutstandingPrincipal", "OutstandingLiability", "DeficitFor", "Deficit", "IsDeficit", "IsIssuanceActive", "Capacity", "SetIssuance", "CanPurchase", "Buy", "ClaimPending", "Mature", "BuildSnapshot", "SendSnapshot", "Use", "Save", "Status" } },
	{ name = "database_admin", methods = { "SendTables", "SendRows", "Mutate", "Start", "Stop" } },
	...
	{ name = "properties", methods = {
		...
		"BuildPermissionAt", "ValidateSpawnPoint", "ValidateEntityPlacement", "ValidateSpawnedEntityPlacement", "LocationAt", "BelongsToProperty",
		"TrespassPropertyAt", "UpdateTrespass", "RefreshTrespassProperty", "ClearTrespassProperty"
	} },
	{ name = "beds", methods = { "RegisterEntity", "Use", "SetHome", "FastTravel", "TeleportHome", "BuildSnapshot", "Save", "Status" } },
